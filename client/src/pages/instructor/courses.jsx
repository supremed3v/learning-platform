...
export default function InstructorCourses(){
    ...
    useEffect(()=>{
        axios.get("http://localhost:3000/api/v1/instructor/courses").then((res) => {
            setCourses(res.data.courses);
            if(res.data.courses.length === 0){
              toast.info("You have not created any courses yet!")
            }
          }
        )
    },[])
...
//     const { data } = await axios.get("http://localhost:3000/api/v1/instructor/courses")
