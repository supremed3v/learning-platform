...
const Login = () => {
  ...
  return (
    <section>
      <Head>
        <title>Login | E-Learn - Online Learning Platform</title>
        <meta name="description" content="Login to start learning" />
          ...
          <div className="g-6 flex h-full flex-wrap items-center justify-center lg:justify-between">
            ...
            <div className="md:w-8/12 lg:ml-6 lg:w-5/12">
              <div className="relative mb-6">
                <input
                  type="text"
                  className="peer block min-h-[auto] w-full rounded border-0 bg-transparent py-[0.32rem] px-3 leading-[2.15] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0 text-black dark:text-neutral-200 dark:placeholder:text-neutral-200"
